    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered table-hover">
                ...
                $sql          = 'select  product.id, product.title, product.price, product.updated_at, product.thumbnail,category.name
              category_name from product left join category on product.id_category=category.id';
